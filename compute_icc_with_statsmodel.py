...
def compute_icc_with_statsmodel(data, bICC_1=True, bICC_A1=False, bICC_C1=False, bICC_k=False, bICC_Ak=False,
                                bICC_Ck=False):
    """
    ...
    ICC_A1 = ICC_C1 = ICC_1 = ICC_k = ICC_Ak = ICC_Ck = np.NAN
    low_ICC_1 = low_ICC_A1 = low_ICC_C1 = low_ICC_k = low_ICC_Ak = low_ICC_Ck = np.NAN
    high_ICC_1 = high_ICC_A1 = high_ICC_C1 = high_ICC_k = high_ICC_Ak = high_ICC_Ck = np.NAN
